...
<div class="container task-list-container">
    <h1 style="font-size: 46px; color:#103961;">Task list</h1>
    ...
    <div class="task-list">
        <div class="lg-3 backlog">
            <h3 style="font-size: 16px; color:#103961;">Backlog</h3>
            <div>
        ...
        <div class="lg-3 inprogress">
            <h3 style="font-size: 16px; color:#103961;">In progress</h3>
            <div>
                <?php
        ...
        <div class="lg-3 test">
            <h3 style="font-size: 16px; color:#103961;">Test</h3>
            <div>
                <?php
        ...
        <div class="lg-3 done">
            <h3 style="font-size: 16px; color:#103961;">Done</h3>
            <div>
                <?php
